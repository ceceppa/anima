...
The animation translates the group children to their current position, as [we haven't defined any final value](/docs/tutorial-basics/fundamentals) for `x`, from an initial position.
